...
<head>
    ...
    <title>Newspeak - Editar Artículo</title>
    <style>
    body {
...
<div class="main-container">
    ...
    <h2 class="section-title">Editar artículo</h2>

    <div class="form-container">
        <form action="${createLink(controller: 'writer', action: 'updateArticle')}" method="POST">
